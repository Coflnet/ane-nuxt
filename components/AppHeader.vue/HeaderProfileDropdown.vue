<template>
  <div class="relative" ref="profileMenuRef" v-if="loggedIn">
    <button @click="isProfileMenuOpen = !isProfileMenuOpen"
      class="flex items-center space-x-1 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 focus:outline-none">
    ...
    <transition name="fade">
      <div v-show="isProfileMenuOpen"
        class="absolute right-0 mt-2 w-60 bg-white dark:bg-slate-800 rounded-md shadow-lg py-1 z-50 border border-slate-200 dark:border-slate-700">
