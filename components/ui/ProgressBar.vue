<template>
  <div class="relative w-full">
    ...
    <div
      ...
      class="absolute top-0 -ml-0.5 transform -translate-x-1/2 transition-all duration-300 ease-in-out -mt-4"
      :style="{ left: `${progressPercentage}%` }"
    >
      <div
        class="font-medium transform rounded-lg border bg-slate-700 border-slate-600 text-sm p-1 -mt-1 text-gray-200 z-50 w-44 text-center"
      >
        {{ indicatorText }}
      </div>
