...
/**
 * Represents a categorized product aggregated from multiple listings
 */
export type Product = {
  /**
  ...
  name?: string | null
  /**
   * Product category (e.g., "Electronics", "Furniture", "Clothing")
   */
  category?: string | null
  /**
  ...
  brand?: string | null
  /**
   * Product model number or identifier
   */
  model?: string | null
  /**
   * Product description
  ...
  /**
   * Number of active listings for this product
   */
  listingCount?: number
  /**
  ...
  /**
   * Highest price across all listings
   */
  ...
  /**
   * When this product was first created
   */
  createdAt?: string
  /**
...
export type SearchProductsData = {
  ...
  query?: {
    /**
     * Search query (searches name, description, brand, model)
     */
    query?: string
    /**
